...
export function disableElement(node) {
  if (!isElement(node)) {
    typeError(
      'disableElement 함수의 인자는 DOM 요소 노드 이어야 합니다.'
    );
  }
  node.disabled = true;
}
...
export function enableElement(node) {
  if (!isElement(node)) {
    typeError(
      'enableElement 함수의 인자는 DOM 요소 노드 이어야 합니다.'
    );
  }
...
export function visibleElement(node) {
  ...
  if (!isElement(node)) {
    typeError(
      'visibleElement 함수의 인자는 DOM 요소 노드 이어야 합니다.'
    );
  }
  node.hidden = false;
}
...
export function invisibleElement(node) {
  ...
  if (!isElement(node)) {
    typeError(
      'invisibleElement 함수의 인자는 DOM 요소 노드 이어야 합니다.'
    );
  }
  node.hidden = true;
}
